// Sadly, all of the crc crates in Rust appear to be insufficient in high
...
// specialty instructions on stable Rust is an absolutely nightmare at the
...
// here: http://create.stephan-brumme.com/crc32/ (Actually, slicing-by-16
// doesn't seem to be measurably faster than slicing-by-8 on my i7-6900K.)
//
...
pub fn crc32c(buf: &[u8]) -> u32 {
    // I can't measure any difference between slice8 with slice16.
    crc32c_slice8(buf)
}
